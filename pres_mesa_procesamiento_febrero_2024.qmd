...
- Se observa que los resultados respecto a la nacionalidad no mantienen coherencia con el Serming. 

- Para el 2024 resaltan al menos cuatro líneas de trabajo: 
  ...
  - Gestionar el acceso mediante convenios a un mayor número de registros administrativos priorizados, al menos Servel, Superintendencia de Salud y Educación. Tomando en cuenta la importancia de mantener contacto con los proveedores. 
   ...
   - Continuar avanzando en la definición de procesos, evaluación de calidad de los insumos y procesos. A la par de estudiar la coherencia con otras fuentes de información. 
